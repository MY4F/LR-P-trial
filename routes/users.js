...
//Mohamed Hesham's page
router.get('/MohamedHesham', (req, res) => {
    User.findOne({ name: 'Mohamed Hesham' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Fredrick Stewart Pre's page
router.get('/FredrickStewartPre', (req, res) => {
    User.findOne({ name: 'Fredrick Stewart Pre' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Amr Sami's page
router.get('/AmrSami', (req, res) => {
    User.findOne({ name: 'Amr Sami' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Hanien Gaballah's page
router.get('/HanienGaballah', (req, res) => {
    User.findOne({ name: 'Hanien Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Gamal Gaballah's page
router.get('/GamalGaballah', (req, res) => {
    User.findOne({ name: 'Gamal Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Toka Hesham's page
router.get('/TokaHesham', (req, res) => {
    User.findOne({ name: 'Toka Hesham' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Abdelrahman Zahran's page
router.get('/AbdelrahmanZahran', (req, res) => {
    User.findOne({ name: 'Abdelrahman Zahran' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Salma's page
router.get('/Salma', (req, res) => {
    User.findOne({ name: 'Salma' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Mark's page
router.get('/StandardUser', (req, res) => {
    User.findOne({ name: 'Mark Henry' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Mohamed Tantawy's page
router.get('/MohamedTantawy', (req, res) => {
    User.findOne({ name: 'Mohamed Tantawy' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Karla's page
router.get('/KarlaMeleka', (req, res) => {
    User.findOne({ name: 'Karla Meleka' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Bassam's page
router.get('/BassamMoataz', (req, res) => {
    User.findOne({ name: 'Bassam Moataz' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
//Dalia Gaballah's page
router.get('/DaliaGaballah', (req, res) => {
    User.findOne({ name: 'Dalia Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/SamirGaballah', (req, res) => {
    User.findOne({ name: 'Samir Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AhmedGaballah', (req, res) => {
    User.findOne({ name: 'Ahmed Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/HeshamZayan', (req, res) => {
    User.findOne({ name: 'Hesham Zayan' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AhmedElKararty', (req, res) => {
    User.findOne({ name: 'Ahmed El Kararty' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/HabibaGaballah', (req, res) => {
    User.findOne({ name: 'Habiba Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/CaptainAbdelnasserMashaal', (req, res) => {
    User.findOne({ name: 'كابتن عبد الناصر مشعل' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/HeshamFathy', (req, res) => {
    User.findOne({ name: 'Hesham Fathy' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AymanMoawad', (req, res) => {
    User.findOne({ name: 'Ayman Moawad' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/SamiaGaballah', (req, res) => {
    User.findOne({ name: 'Samia Gaballah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/KareemWaleedElFahla', (req, res) => {
    User.findOne({ name: 'Kareem Waleed El Fahla' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AhmedElBatrawy', (req, res) => {
    User.findOne({ name: 'Ahmed El Batrawy' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AhmedMahfouz', (req, res) => {
    User.findOne({ name: 'Ahmed Mahfouz' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AnnaYud', (req, res) => {
    User.findOne({ name: 'Anastasia Yud' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/MohamedAbdelMonaem', (req, res) => {
    User.findOne({ name: 'Mohamed Abdel Monaem' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/MahmoudAntar', (req, res) => {
    User.findOne({ name: 'Mahmoud Antar' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/MuhammedHussien', (req, res) => {
    User.findOne({ name: 'Muhammed Hussien' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AmrHashem', (req, res) => {
    User.findOne({ name: 'Amr Hashem' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/MoustafaHashem', (req, res) => {
    User.findOne({ name: 'Moustafa Hashem' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/NazlyFoda', (req, res) => {
    User.findOne({ name: 'Nazly Foda' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/SohailaHashem', (req, res) => {
    User.findOne({ name: 'Sohaila Hashem' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/MohamedYehia', (req, res) => {
    User.findOne({ name: 'Mohamed Yahia' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/EmanBastah', (req, res) => {
    User.findOne({ name: 'Eman Bastah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/EssamBastah', (req, res) => {
    User.findOne({ name: 'Essam Bastah' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/DanielHanna', (req, res) => {
    User.findOne({ name: 'Daniel Hanna' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/shikoostore', (req, res) => {
    User.findOne({ name: 'Shikoo Store' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/Antarvie-A', (req, res) => {
    User.findOne({ email: 'Abdulrazak137090@gmail.com' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
...
router.get('/AhmedHedayet', (req, res) => {
    User.findOne({ name: 'Ahmed Hedayet' }).then(user => {
        res.render(dir + '/views/ClientProfilePre.ejs', {
            bio: user.bio,
            icons: user.icons,
            links: user.links,
